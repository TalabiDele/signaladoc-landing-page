...
const EmailComponent = () => {
  ...
  return (
    <div className="flex fixed right-0 left-0 -z-10 xs:flex-col ss:flex-col">
      ...
      >
        <div className=" relative top-[3rem] left-20 right-0 w-[80%] sm:left-10 xs:w-[80%] xs:left-0 xs:top-[7rem] xs:mx-auto ss:w-[80%] ss:left-0 ss:mx-auto ss:top-[7rem] sm:top-[7rem]">
          {isEmail && (
            <div className=" xs:hidden ss:hidden">
              <h1 className="font-bold text-5xl mb-10 lg:text-3xl sm:text-3xl sm:mb-5 ">
                A <span className=" text-primary">Doctor</span> In Your Pocket
              </h1>
              <p className=" text-[24px] w-3/5 mb-10 lg:text-[18px] lg:w-4/5 sm:text-[18px] sm:w-full">
                With our telemedicine app, you can consult with a doctor
                wherever you are on the go, 24/7.
              </p>
            </div>
          )}
